...
// UNIVERSAL AI SECTION SAVER
router.post('/iteration2/save/:section', function (req, res) {

  const section = req.params.section;     // example: ai-condition-history
  const varName = "ai_ack_" + section.replace(/-/g, "_");  // ai_ack_ai_condition_history

  // Save checkbox as boolean (true if checked)
  req.session.data[varName] = req.body[varName] === "true";

  // Redirect depending on button clicked
  if (req.body.action === "continue") {

    const nextPage = {
      "ai-condition-history": "/iteration2/ai-medication",
      "ai-medication": "/iteration2/ai-social-occupational-history",
      "ai-social-occupational-history": "/iteration2/ai-section1",
      "ai-section1": "/iteration2/ai-section2",
      "ai-section2": "/iteration2/ai-section3",
      "ai-section3": "/iteration2/ai-section4",
      "ai-section4": "/iteration2/ai-section5",
      "ai-section5": "/iteration2/ai-section6",
      "ai-section6": "/iteration2/ai-section7",
      "ai-section7": "/iteration2/ai-section8",
      "ai-section8": "/iteration2/ai-section9",
      "ai-section9": "/iteration2/ai-section10",
      "ai-section10": "/iteration2/ai-section11",
      "ai-section11": "/iteration2/ai-section12",
      "ai-section12": "/iteration2/ai-section13",
      "ai-section13": "/iteration2/review-ai-report-start"
    };

    return res.redirect(nextPage[section]);
  }
